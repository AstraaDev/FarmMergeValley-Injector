...
```
- There will normally be 11 results. Navigate to the 4th result and set a breakpoint by clicking on the left of the line in the grey area *(see image below)*
